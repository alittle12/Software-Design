...
public class CCScheduleMaster {
	...
	public void adminGUI() 
	{
		...
		//	dr.tableMaker(.getSelectedFiles.getText());
			JOptionPane.showMessageDialog(null, "Data successfully uploaded");
		}
		catch(SQLException e) {
				JOptionPane.showMessageDialog(null, "There was a problem adding this data, please try another file.");
	...
	/**
	 * Creates the Student GUI and adds the buttons described in our mock up
	 */
	...
	/**
	 * This class provides an actionlistener for the jcombobox that allows the user to select which of their schedules they want to retrieve
	 * @author andrewlittle
	 *
	 */
